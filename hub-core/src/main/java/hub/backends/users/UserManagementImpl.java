...
public class UserManagementImpl implements UserManagement {
    ...
    public static final Logger myLogger = LoggerFactory.getLogger(UserManagementImpl.class);
...
//        Person p = getAllPersonsMap().get(researcher);
//        if ( p == null ) {
...
//        Person p = getAllPersonsMap().get(adviser);
//        if ( p == null ) {
//            return Optional.empty();
//        } else {
...
//    }
    ...
    public Group getGroup(String groupAlias) {
        return getAllGroupsMap().get(groupAlias);
    }

    @Override
    public Collection<Group> getAllGroups() {
        return getAllGroupsMap().values();
    }

    private synchronized Map<String, Group> getAllGroupsMap() {
    ...
    private synchronized void addAdmins(Map<String, Person> allPersons) {
    ...
    @Override
    public Person getPerson(String personAlias) {
        return getAllPersonsMap().get(personAlias);
    }

    @Override
    public Set<String> getAllPersonAliases() {
        return getAllPersonsMap().keySet();
    }

    @Override
    public Collection<Person> getAllPersons() {
        return getAllPersonsMap().values();
    }


    private synchronized Map<String, Person> getAllPersonsMap() {
