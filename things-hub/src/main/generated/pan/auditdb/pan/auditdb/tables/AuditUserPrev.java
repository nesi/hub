...
public class AuditUserPrev extends org.jooq.impl.TableImpl<pan.auditdb.tables.records.AuditUserPrevRecord> {
	 ...
	 */
	@Override
	public Class<pan.auditdb.tables.records.AuditUserPrevRecord> getRecordType() {
	 ...
	 */
	public final org.jooq.TableField<pan.auditdb.tables.records.AuditUserPrevRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR.length(45), this, "");

	/**
	 * The column <code>pandora_audit.audit_user_prev.jobs</code>.
	 */
	public final org.jooq.TableField<pan.auditdb.tables.records.AuditUserPrevRecord, Long> JOBS = createField("jobs", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final org.jooq.TableField<pan.auditdb.tables.records.AuditUserPrevRecord, String> MONTH = createField("month", org.jooq.impl.SQLDataType.VARCHAR.length(2), this, "");

	/**
	 * The column <code>pandora_audit.audit_user_prev.year</code>.
	 */
	public final org.jooq.TableField<pan.auditdb.tables.records.AuditUserPrevRecord, String> YEAR = createField("year", org.jooq.impl.SQLDataType.VARCHAR.length(4), this, "");
	 ...
	 */
	public AuditUserPrev(String alias) {
		this(alias, pan.auditdb.tables.AuditUserPrev.AUDIT_USER_PREV);
	}

	private AuditUserPrev(String alias, org.jooq.Table<pan.auditdb.tables.records.AuditUserPrevRecord> aliased) {
		this(alias, aliased, null);
	}

	private AuditUserPrev(String alias, org.jooq.Table<pan.auditdb.tables.records.AuditUserPrevRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public pan.auditdb.tables.AuditUserPrev as(String alias) {
	 ...
	 * Rename this table
	 */
	public pan.auditdb.tables.AuditUserPrev rename(String name) {
