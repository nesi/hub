...
public class Keys {
	...
	public static final org.jooq.Identity<projectdb.tables.records.ResearcherRecord, Integer> IDENTITY_RESEARCHER = Identities0.IDENTITY_RESEARCHER;
	public static final org.jooq.Identity<projectdb.tables.records.ResearcherPropertiesRecord, Integer> IDENTITY_RESEARCHER_PROPERTIES = Identities0.IDENTITY_RESEARCHER_PROPERTIES;
	public static final org.jooq.Identity<projectdb.tables.records.ResearcherStatusRecord, Integer> IDENTITY_RESEARCHER_STATUS = Identities0.IDENTITY_RESEARCHER_STATUS;
	public static final org.jooq.Identity<projectdb.tables.records.ResearchoutputRecord, Integer> IDENTITY_RESEARCHOUTPUT = Identities0.IDENTITY_RESEARCHOUTPUT;
	...
	private static class Identities0 extends org.jooq.impl.AbstractKeys {
		public static org.jooq.Identity<projectdb.tables.records.AdviserRecord, Integer> IDENTITY_ADVISER = createIdentity(projectdb.tables.Adviser.ADVISER, projectdb.tables.Adviser.ADVISER.ID);
		public static org.jooq.Identity<projectdb.tables.records.AdviseractionRecord, Integer> IDENTITY_ADVISERACTION = createIdentity(projectdb.tables.Adviseraction.ADVISERACTION, projectdb.tables.Adviseraction.ADVISERACTION.ID);
		public static org.jooq.Identity<projectdb.tables.records.AdviserPropertiesRecord, Integer> IDENTITY_ADVISER_PROPERTIES = createIdentity(projectdb.tables.AdviserProperties.ADVISER_PROPERTIES, projectdb.tables.AdviserProperties.ADVISER_PROPERTIES.ID);
		public static org.jooq.Identity<projectdb.tables.records.AttachmentRecord, Integer> IDENTITY_ATTACHMENT = createIdentity(projectdb.tables.Attachment.ATTACHMENT, projectdb.tables.Attachment.ATTACHMENT.ID);
		public static org.jooq.Identity<projectdb.tables.records.ChangelogRecord, Integer> IDENTITY_CHANGELOG = createIdentity(projectdb.tables.Changelog.CHANGELOG, projectdb.tables.Changelog.CHANGELOG.ID);
		public static org.jooq.Identity<projectdb.tables.records.DepartmentRecord, Integer> IDENTITY_DEPARTMENT = createIdentity(projectdb.tables.Department.DEPARTMENT, projectdb.tables.Department.DEPARTMENT.ID);
		public static org.jooq.Identity<projectdb.tables.records.DivisionRecord, Integer> IDENTITY_DIVISION = createIdentity(projectdb.tables.Division.DIVISION, projectdb.tables.Division.DIVISION.ID);
		public static org.jooq.Identity<projectdb.tables.records.InstitutionRecord, Integer> IDENTITY_INSTITUTION = createIdentity(projectdb.tables.Institution.INSTITUTION, projectdb.tables.Institution.INSTITUTION.ID);
		public static org.jooq.Identity<projectdb.tables.records.ProjectRecord, Integer> IDENTITY_PROJECT = createIdentity(projectdb.tables.Project.PROJECT, projectdb.tables.Project.PROJECT.ID);
		public static org.jooq.Identity<projectdb.tables.records.ProjectfollowupRecord, Integer> IDENTITY_PROJECTFOLLOWUP = createIdentity(projectdb.tables.Projectfollowup.PROJECTFOLLOWUP, projectdb.tables.Projectfollowup.PROJECTFOLLOWUP.ID);
		public static org.jooq.Identity<projectdb.tables.records.ProjectreviewRecord, Integer> IDENTITY_PROJECTREVIEW = createIdentity(projectdb.tables.Projectreview.PROJECTREVIEW, projectdb.tables.Projectreview.PROJECTREVIEW.ID);
		public static org.jooq.Identity<projectdb.tables.records.ProjectKpiRecord, Integer> IDENTITY_PROJECT_KPI = createIdentity(projectdb.tables.ProjectKpi.PROJECT_KPI, projectdb.tables.ProjectKpi.PROJECT_KPI.ID);
		public static org.jooq.Identity<projectdb.tables.records.ProjectPropertiesRecord, Integer> IDENTITY_PROJECT_PROPERTIES = createIdentity(projectdb.tables.ProjectProperties.PROJECT_PROPERTIES, projectdb.tables.ProjectProperties.PROJECT_PROPERTIES.ID);
		public static org.jooq.Identity<projectdb.tables.records.ProjectStatusRecord, Integer> IDENTITY_PROJECT_STATUS = createIdentity(projectdb.tables.ProjectStatus.PROJECT_STATUS, projectdb.tables.ProjectStatus.PROJECT_STATUS.ID);
		public static org.jooq.Identity<projectdb.tables.records.ResearcherRecord, Integer> IDENTITY_RESEARCHER = createIdentity(projectdb.tables.Researcher.RESEARCHER, projectdb.tables.Researcher.RESEARCHER.ID);
		public static org.jooq.Identity<projectdb.tables.records.ResearcherPropertiesRecord, Integer> IDENTITY_RESEARCHER_PROPERTIES = createIdentity(projectdb.tables.ResearcherProperties.RESEARCHER_PROPERTIES, projectdb.tables.ResearcherProperties.RESEARCHER_PROPERTIES.ID);
		public static org.jooq.Identity<projectdb.tables.records.ResearcherStatusRecord, Integer> IDENTITY_RESEARCHER_STATUS = createIdentity(projectdb.tables.ResearcherStatus.RESEARCHER_STATUS, projectdb.tables.ResearcherStatus.RESEARCHER_STATUS.ID);
		public static org.jooq.Identity<projectdb.tables.records.ResearchoutputRecord, Integer> IDENTITY_RESEARCHOUTPUT = createIdentity(projectdb.tables.Researchoutput.RESEARCHOUTPUT, projectdb.tables.Researchoutput.RESEARCHOUTPUT.ID);
	}
