...
public class Kpi extends org.jooq.impl.TableImpl<projectdb.tables.records.KpiRecord> {
     ...
     */
    public final org.jooq.TableField<projectdb.tables.records.KpiRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>projectdb.kpi.measures</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.KpiRecord, String> MEASURES = createField("measures", org.jooq.impl.SQLDataType.CLOB.length(65535).nullable(false), this, "");
    /**
     * The column <code>projectdb.kpi.title</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.KpiRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.CLOB.length(65535).nullable(false), this, "");
    /**
     * The column <code>projectdb.kpi.type</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.KpiRecord, String> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false), this, "");
    ...
    private Kpi(String alias, org.jooq.Table<projectdb.tables.records.KpiRecord> aliased) {
        this(alias, aliased, null);
    }

    private Kpi(String alias, org.jooq.Table<projectdb.tables.records.KpiRecord> aliased, org.jooq.Field<?>[] parameters) {
     ...
     */
    @Override
    public projectdb.tables.Kpi as(String alias) {
     ...
     */
    @Override
    public Class<projectdb.tables.records.KpiRecord> getRecordType() {
     ...
     * Rename this table
     */
    public projectdb.tables.Kpi rename(String name) {
