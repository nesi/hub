...
public class Projecttype extends org.jooq.impl.TableImpl<projectdb.tables.records.ProjecttypeRecord> {
     ...
     */
    public final org.jooq.TableField<projectdb.tables.records.ProjecttypeRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>projectdb.projecttype.name</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.ProjecttypeRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(100), this, "");
    ...
    private Projecttype(String alias, org.jooq.Table<projectdb.tables.records.ProjecttypeRecord> aliased) {
        this(alias, aliased, null);
    }

    private Projecttype(String alias, org.jooq.Table<projectdb.tables.records.ProjecttypeRecord> aliased, org.jooq.Field<?>[] parameters) {
     ...
     */
    @Override
    public projectdb.tables.Projecttype as(String alias) {
     ...
     */
    @Override
    public Class<projectdb.tables.records.ProjecttypeRecord> getRecordType() {
     ...
     * Rename this table
     */
    public projectdb.tables.Projecttype rename(String name) {
