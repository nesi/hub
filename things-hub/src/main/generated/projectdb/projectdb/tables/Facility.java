...
public class Facility extends org.jooq.impl.TableImpl<projectdb.tables.records.FacilityRecord> {
	 ...
	 */
	@Override
	public Class<projectdb.tables.records.FacilityRecord> getRecordType() {
	 ...
	 */
	public final org.jooq.TableField<projectdb.tables.records.FacilityRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>projectdb.facility.name</code>.
	 */
	public final org.jooq.TableField<projectdb.tables.records.FacilityRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(100), this, "");

	/**
	 * The column <code>projectdb.facility.siteId</code>.
	 */
	public final org.jooq.TableField<projectdb.tables.records.FacilityRecord, Integer> SITEID = createField("siteId", org.jooq.impl.SQLDataType.INTEGER, this, "");
	...
	private Facility(String alias, org.jooq.Table<projectdb.tables.records.FacilityRecord> aliased) {
		this(alias, aliased, null);
	}

	private Facility(String alias, org.jooq.Table<projectdb.tables.records.FacilityRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public projectdb.tables.Facility as(String alias) {
	 ...
	 * Rename this table
	 */
	public projectdb.tables.Facility rename(String name) {
