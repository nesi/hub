...
public class ResearcherProject extends org.jooq.impl.TableImpl<projectdb.tables.records.ResearcherProjectRecord> {
     ...
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherProjectRecord, String> NOTES = createField("notes", org.jooq.impl.SQLDataType.CLOB.length(65535).nullable(false), this, "");
    /**
     * The column <code>projectdb.researcher_project.projectId</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherProjectRecord, Integer> PROJECTID = createField("projectId", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>projectdb.researcher_project.researcherId</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherProjectRecord, Integer> RESEARCHERID = createField("researcherId", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>projectdb.researcher_project.researcherRoleId</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherProjectRecord, Integer> RESEARCHERROLEID = createField("researcherRoleId", org.jooq.impl.SQLDataType.INTEGER, this, "");
     ...
     */
    public ResearcherProject(String alias) {
        this(alias, projectdb.tables.ResearcherProject.RESEARCHER_PROJECT);
    }

    private ResearcherProject(String alias, org.jooq.Table<projectdb.tables.records.ResearcherProjectRecord> aliased) {
        this(alias, aliased, null);
    }

    private ResearcherProject(String alias, org.jooq.Table<projectdb.tables.records.ResearcherProjectRecord> aliased, org.jooq.Field<?>[] parameters) {
     ...
     */
    @Override
    public projectdb.tables.ResearcherProject as(String alias) {
     ...
     */
    @Override
    public Class<projectdb.tables.records.ResearcherProjectRecord> getRecordType() {
     ...
     * Rename this table
     */
    public projectdb.tables.ResearcherProject rename(String name) {
