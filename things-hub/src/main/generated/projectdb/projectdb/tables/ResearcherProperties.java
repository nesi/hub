...
public class ResearcherProperties extends org.jooq.impl.TableImpl<projectdb.tables.records.ResearcherPropertiesRecord> {
     ...
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherPropertiesRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>projectdb.researcher_properties.propname</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherPropertiesRecord, String> PROPNAME = createField("propname", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaulted(true), this, "");
    /**
     * The column <code>projectdb.researcher_properties.propvalue</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherPropertiesRecord, String> PROPVALUE = createField("propvalue", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
    /**
     * The column <code>projectdb.researcher_properties.researcherId</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherPropertiesRecord, Integer> RESEARCHERID = createField("researcherId", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");
    /**
     * The column <code>projectdb.researcher_properties.siteId</code>.
     */
    public final org.jooq.TableField<projectdb.tables.records.ResearcherPropertiesRecord, Integer> SITEID = createField("siteId", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");
    /**
     ...
     */
    public ResearcherProperties(String alias) {
        this(alias, projectdb.tables.ResearcherProperties.RESEARCHER_PROPERTIES);
    }

    private ResearcherProperties(String alias, org.jooq.Table<projectdb.tables.records.ResearcherPropertiesRecord> aliased) {
        this(alias, aliased, null);
    }

    private ResearcherProperties(String alias, org.jooq.Table<projectdb.tables.records.ResearcherPropertiesRecord> aliased, org.jooq.Field<?>[] parameters) {
     ...
     */
    @Override
    public projectdb.tables.ResearcherProperties as(String alias) {
     ...
     */
    @Override
    public org.jooq.Identity<projectdb.tables.records.ResearcherPropertiesRecord, Integer> getIdentity() {
     ...
     */
    @Override
    public Class<projectdb.tables.records.ResearcherPropertiesRecord> getRecordType() {
     ...
     * Rename this table
     */
    public projectdb.tables.ResearcherProperties rename(String name) {
