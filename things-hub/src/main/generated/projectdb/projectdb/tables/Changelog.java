...
public class Changelog extends org.jooq.impl.TableImpl<projectdb.tables.records.ChangelogRecord> {
	 ...
	 */
	@Override
	public Class<projectdb.tables.records.ChangelogRecord> getRecordType() {
	 ...
	 */
	public final org.jooq.TableField<projectdb.tables.records.ChangelogRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>projectdb.changelog.tbl</code>.
	 */
	public final org.jooq.TableField<projectdb.tables.records.ChangelogRecord, String> TBL = createField("tbl", org.jooq.impl.SQLDataType.VARCHAR.length(11).nullable(false), this, "");

	/**
	 * The column <code>projectdb.changelog.tbl_id</code>.
	 */
	public final org.jooq.TableField<projectdb.tables.records.ChangelogRecord, Integer> TBL_ID = createField("tbl_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>projectdb.changelog.field</code>.
	 */
	public final org.jooq.TableField<projectdb.tables.records.ChangelogRecord, String> FIELD = createField("field", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>projectdb.changelog.old_val</code>.
	 */
	public final org.jooq.TableField<projectdb.tables.records.ChangelogRecord, String> OLD_VAL = createField("old_val", org.jooq.impl.SQLDataType.CLOB, this, "");

	/**
	 * The column <code>projectdb.changelog.new_val</code>.
	 */
	public final org.jooq.TableField<projectdb.tables.records.ChangelogRecord, String> NEW_VAL = createField("new_val", org.jooq.impl.SQLDataType.CLOB, this, "");
	 ...
	 */
	public final org.jooq.TableField<projectdb.tables.records.ChangelogRecord, Integer> ADVISERID = createField("adviserId", org.jooq.impl.SQLDataType.INTEGER, this, "adviser who performed this change");
	...
	private Changelog(String alias, org.jooq.Table<projectdb.tables.records.ChangelogRecord> aliased) {
		this(alias, aliased, null);
	}

	private Changelog(String alias, org.jooq.Table<projectdb.tables.records.ChangelogRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public org.jooq.Identity<projectdb.tables.records.ChangelogRecord, Integer> getIdentity() {
	 ...
	 */
	@Override
	public projectdb.tables.Changelog as(String alias) {
	 ...
	 * Rename this table
	 */
	public projectdb.tables.Changelog rename(String name) {
